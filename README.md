...
### 1. IBM i 開発ハンズオン（日本Powerテクニカルセールス版）

IBM BobをIBM i開発で活用する方法を学ぶ実践的なハンズオン資料です。

📖 **[1_ibmi-hands-on-JPAN-TechSales](./1_ibmi-hands-on-JPAN-TechSales/README.md)**
...
📖 **[2_ibmi-hands-on-EMEA-CE-ja](./2_ibmi-hands-on-EMEA-CE-ja/README.md)**
...
**日本Powerテクニカルセールス版（基礎編）:**
```bash
cd 1_ibmi-hands-on-JPAN-TechSales
```
📖 **[README.md](./1_ibmi-hands-on-JPAN-TechSales/README.md)** を開いて、詳細な手順を確認してください。

**EMEA CE版（モダナイゼーション編）:**
```bash
cd 2_ibmi-hands-on-EMEA-CE-ja
```
📖 **[README.md](./2_ibmi-hands-on-EMEA-CE-ja/README.md)** を開いて、詳細な手順を確認してください。
...
👉 **基礎から学ぶ**: [IBM i開発ハンズオン（日本Powerテクニカルセールス版）](./1_ibmi-hands-on-JPAN-TechSales/README.md)

👉 **モダナイゼーションを学ぶ**: [アプリケーションモダナイゼーション（EMEA CE版）](./2_ibmi-hands-on-EMEA-CE-ja/README.md)
